...
describe("10 - Crie o filtro pelo nome da carta", () => {
  ...
  it("Será validado se apenas as cartas correspondentes aparecem após o filtro", () => {
    ...
    userEvent.type(
      descInput,
      "Quando um bebedouro está na cidade de Bebedouro, ele se sente em casa"
    );
    userEvent.type(attr1Input, "90");
    userEvent.type(attr2Input, "90");
    userEvent.type(attr3Input, "30");
    ...
    expect(
      screen.getByText("Carta 2 - Bebedouro de Bebedouro")
    ).toBeInTheDocument();
    expect(
      screen.queryByText("Carta 3 - Fonte natural")
